...
function matchWithChecks(segmentGroup, route, segments, injector, urlSerializer, abortSignal) {
  ...
  return runCanMatchGuards(injector, route, segments, urlSerializer, abortSignal).pipe((0, import_operators.map)((v) => v === true ? result : __spreadValues({}, noMatch$1)));
}
...
function recognize$2(injector, configLoader, rootComponentType, config, urlTree, urlSerializer, paramsInheritanceStrategy = "emptyOnly", abortSignal) {
  return __async(this, null, function* () {
...
function noMatch(segmentGroup) {
  return (0, import_rxjs.throwError)(new NoMatch2(segmentGroup));
}
...
var Recognizer2 = class {
  ...
  processSegment(injector, routes, segmentGroup, segments, outlet, allowRedirects, parentRoute) {
    return (0, import_rxjs.from)(routes).pipe((0, import_operators.concatMap)((r) => {
      ...
      if (isEmptyError(e)) {
        if (noLeftoversInUrl(segmentGroup, segments, outlet)) {
          return (0, import_rxjs.of)(new NoLeftoversInUrl2());
        }
  ...
  getChildConfig(injector, route, segments) {
    ...
    if (route.loadChildren) {
      ...
      return runCanLoadGuards(injector, route, segments, this.urlSerializer).pipe((0, import_operators.mergeMap)((shouldLoadResult) => {
        if (shouldLoadResult) {
          return (0, import_rxjs.from)(this.configLoader.loadChildren(injector, route)).pipe((0, import_operators.tap)((cfg) => {
            route._loadedRoutes = cfg.routes;
            route._loadedInjector = cfg.injector;
          }));
        }
...
function recognize(injector, configLoader, rootComponentType, config, serializer, paramsInheritanceStrategy, abortSignal) {
  ...
  return (0, import_operators.mergeMap)((t) => (0, import_rxjs.of)(t).pipe((0, import_operators.switchMap)((t2) => recognizeImpl(injector, configLoader, rootComponentType, config, t2.extractedUrl, serializer, paramsInheritanceStrategy, abortSignal)), (0, import_operators.map)(({
...
var NavigationTransitions = class _NavigationTransitions {
  ...
  setupNavigations(router) {
    ...
    return this.transitions.pipe((0, import_operators.filter)((t) => t !== null), (0, import_operators.switchMap)((overallTransitionState) => {
      ...
      }), checkGuards(this.environmentInjector, (evt) => this.events.next(evt)), (0, import_operators.tap)((t) => {
      ...
      }), activateRoutes(this.rootContexts, router.routeReuseStrategy, (evt) => this.events.next(evt), this.inputBindingEnabled), (0, import_operators.take)(1), (0, import_operators.takeUntil)(abortSignalToObservable(abortController.signal).pipe((0, import_operators.filter)(() => !completedOrAborted && !overallTransitionState.targetRouterState), (0, import_operators.tap)(() => {
...
//# sourceMappingURL=chunk-F4O4BV4G.js.map
